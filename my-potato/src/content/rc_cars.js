...
const rcCarMilestones = [
  ...
  },
  {
    title: `Servo Motors`,
    document: [
      `A servo motor is responsible for precise control of angular position, velocity, and acceleration. It's typically used for steering and controlling other movable parts`,
...
function RCCars() {
  return (
    <div id="rc-car-content">
      {rcCarMilestones.map((item, index) => (
