const html_website = [
    ...
    },
    {
        ...
        document: [
            `I used GoDaddy for purchasing domain name. There are tons of options available, such as com, net, org, io, etc. 
            I chose the cheap one that comes with a 3-year term.`
        ],
        pictures: [
            { src: ``, alt: `` }
        ]
    },
    {
        ...
        document: [
            `I chose BlueHost because it comes with cPanel control option. After you register an account, follow the given instruction 
            to link your domain to the web hosting provider, in this case, it'd be BlueHost.`
        ],
        pictures: [
            { src: ``, alt: `` }
        ]
